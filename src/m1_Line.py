...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end=end.clone()
        self.cloneCount=0
        self.startPointOriginal= start
        self.endPointOriginal=end
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        point1=self.start.halfway_to(self.end)
        return point1
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.start=self.startPointOriginal
        self.end=self.endPointOriginal
